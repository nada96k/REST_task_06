...
from .permissions import LoggedInUser, FutureBooking
...
class BookingDetails(RetrieveAPIView):
	...
	permission_classes = [IsAuthenticated, LoggedInUser]
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	lookup_field = 'id'
	lookup_url_kwarg = 'booking_id'
	permission_classes = [IsAuthenticated, LoggedInUser, FutureBooking]
